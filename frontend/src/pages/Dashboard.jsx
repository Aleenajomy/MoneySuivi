        ...
        {loadingAnalytics ? (
          ...
          <>
            <div className="card p-4 animate-slideLeft">
              ...
              <p className="dark:text-gray-100 text-slate-800 font-bold text-lg">{formatCurrency(totalIncome)}</p>
            ...
            <div className="card p-4 animate-slideRight">
              ...
              <p className="dark:text-gray-100 text-slate-800 font-bold text-lg">{formatCurrency(totalExpense)}</p>
              <div className="mt-2 h-1 dark:bg-dark-border bg-light-border rounded-full">
