    ...
    <div className="page pb-24 animate-fadeIn space-y-6">
      ...
      <div className="rounded-3xl p-6 relative overflow-hidden shadow-xl text-white"
        ...
        <p className="text-white/60 text-[10px] font-semibold mt-1">
          Formula: Assets ({formatCurrency(summary.totalAssets)}) + Receivables ({formatCurrency(summary.ledgerReceivable || 0)}) − Liabilities ({formatCurrency(summary.totalLiabilities)}) − Payables ({formatCurrency(summary.ledgerPayable || 0)})
        </p>
      </div>
